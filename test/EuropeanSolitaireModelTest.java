...
/**
 * A JUnit test class for {@link EuropeanSolitaireModel}s.
 */
public class EuropeanSolitaireModelTest {
  ...
  @Before
  public void init() {
    defaultConstructor = new EuropeanSolitaireModel();
    armLength5 = new EuropeanSolitaireModel(5);
    armLength7 = new EuropeanSolitaireModel(7);
    specifiedEmptySlot = new EuropeanSolitaireModel(1, 1);
    specifiedEmptySlotAndArmLength5 = new EuropeanSolitaireModel(5, 5, 2);
  }
  ...
  public void testValidConstructionWithDefaultConstructor() {
    assertEquals(36, this.defaultConstructor.getScore());
  ...
  public void testValidConstructionWithSpecifiedArmLengthConstructor() {
    assertEquals(128, this.armLength5.getScore());
  ...
  public void testInvalidConstructionWithArmLength1() {
    MarbleSolitaireModel model = new EuropeanSolitaireModel(1);
  }

  // testing for an exception when a model is made with a negative arm length
  @Test(expected = IllegalArgumentException.class)
  public void testInvalidConstructionWithNegArmLength() {
    MarbleSolitaireModel model = new EuropeanSolitaireModel(-10);
  }
  ...
  public void testValidConstructionWithSpecifiedEmptySlotConstructor() {
    assertEquals(36, this.specifiedEmptySlot.getScore());
    ...
    assertEquals(MarbleSolitaireModelState.SlotState.Invalid,
            this.specifiedEmptySlot.getSlotAt(6, 6));
  }
  ...
  public void testInvalidConstructionWithInvalidEmptySlot() {
    MarbleSolitaireModel model = new EuropeanSolitaireModel(0, 0);
  }
  ...
  public void testInvalidConstructionWithInvalidEmptySlot2() {
    MarbleSolitaireModel model = new EuropeanSolitaireModel(0, 6);
  }
  ...
  public void testInvalidConstructionWithInvalidEmptySlot3() {
    MarbleSolitaireModel model = new EuropeanSolitaireModel(6, 0);
  }
  ...
  public void testInvalidConstructionWithInvalidEmptySlot4() {
    MarbleSolitaireModel model = new EuropeanSolitaireModel(6, 6);
  }
  ...
  public void testInvalidConstructionWithOutOfBoundsEmptySlot() {
    MarbleSolitaireModel model = new EuropeanSolitaireModel(-100, 3);
  }
  ...
  public void testInvalidConstructionWithOutOfBoundsEmptySlot3() {
    MarbleSolitaireModel model = new EuropeanSolitaireModel(3, -100);
  }
  ...
  public void testValidConstructionWithSpecifiedArmLengthAndEmptySpotConstructor() {
    assertEquals(128, this.specifiedEmptySlotAndArmLength5.getScore());
    ...
    assertEquals(MarbleSolitaireModelState.SlotState.Marble,
            this.specifiedEmptySlotAndArmLength5.getSlotAt(3, 1));
  }
  ...
  public void testInvalidConstructionComplexConstructor() {
    MarbleSolitaireModel model = new EuropeanSolitaireModel(1, 3, 3);
  }

  // testing for an exception when the arm thickness is not odd with a different constructor
  @Test(expected = IllegalArgumentException.class)
  public void testInvalidConstructionComplexConstructor2() {
    MarbleSolitaireModel model = new EuropeanSolitaireModel(-10, 3, 3);
  }
  ...
  public void testInvalidConstructionComplexConstructor3() {
    MarbleSolitaireModel model = new EuropeanSolitaireModel(5, 25, 30);
  }
  ...
  public void testInvalidConstructionComplexConstructor4() {
    MarbleSolitaireModel model = new EuropeanSolitaireModel(7, -3, 0);
  }
  ...
  public void testInvalidConstructionComplexConstructor5() {
    MarbleSolitaireModel model = new EuropeanSolitaireModel(3, 0, 0);
  }
  ...
  public void testInvalidConstructionComplexConstructor6() {
    MarbleSolitaireModel model = new EuropeanSolitaireModel(3, 6, 6);
  }
  ...
  public void testInvalidConstructionComplexConstructor7() {
    MarbleSolitaireModel model = new EuropeanSolitaireModel(-20, 5, 5);
  }
  ...
  public void testLeftMove() {
    ...
    assertEquals(MarbleSolitaireModelState.SlotState.Empty,
            this.defaultConstructor.getSlotAt(3, 3));
    assertEquals(36, defaultConstructor.getScore());
    ...
    assertEquals(MarbleSolitaireModelState.SlotState.Marble,
            this.defaultConstructor.getSlotAt(3, 3));
    assertEquals(35, defaultConstructor.getScore());
  }
  ...
  public void testMultipleMoves() {
    ...
    assertEquals(MarbleSolitaireModelState.SlotState.Marble,
            this.defaultConstructor.getSlotAt(3, 2));
    assertEquals(34, defaultConstructor.getScore());
  }
  ...
  public void testIsGameOver() {
    ...
    assertFalse(this.defaultConstructor.isGameOver());
    this.defaultConstructor.move(5, 1, 3, 1);
    assertFalse(this.defaultConstructor.isGameOver());
    ...
    assertFalse(this.defaultConstructor.isGameOver());
    this.defaultConstructor.move(3,0,3,2);
  ...
  public void testGetSlotAtWithSpecifiedArmLengthConstructor() {
    ...
    assertEquals(MarbleSolitaireModelState.SlotState.Invalid,
            this.armLength5.getSlotAt(1, 1));
    assertEquals(MarbleSolitaireModelState.SlotState.Marble,
            this.armLength5.getSlotAt(10, 10));
    assertEquals(MarbleSolitaireModelState.SlotState.Invalid,
  ...
  public void testGetSlotAtWithSpecifiedEmptySlotConstructor() {
    ...
    assertEquals(MarbleSolitaireModelState.SlotState.Marble,
            this.specifiedEmptySlot.getSlotAt(5, 5));
    assertEquals(MarbleSolitaireModelState.SlotState.Invalid,
  ...
  public void testGetScore() {
    assertEquals(36, this.defaultConstructor.getScore());
    assertEquals(128, this.armLength5.getScore());
    assertEquals(276, this.armLength7.getScore());
    assertEquals(36, this.specifiedEmptySlot.getScore());
    assertEquals(128, this.specifiedEmptySlotAndArmLength5.getScore());
  }
}